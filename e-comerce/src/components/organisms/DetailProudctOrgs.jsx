      ...
      <div className="card mt-[5.7rem] mx-2 py-5 px-5 box-border bg-white rounded-xl shadow-lg shadow-slate-200 overflow-hidden mb-8">
        <div className="mb-3 sm:flex sm:gap-5 sm:justify-between sm:items-center">
          ...
          <div className="desc sm:mr-10">
            ...
            <div className="footer fixed bg-white bg-opacity-5 backdrop-blur-md bottom-0 z-10 left-0 right-0 py-4 px-7 border-t-2 flex justify-between items-center gap-3 sm:static sm:px-0 sm:gap-0 sm:justify-center">
              <Link className="bg-green-500 text-white py-2 px-3 rounded-lg text-md font-extralight text-center leading-5 flex justify-center item sm:rounded-none sm:py-[.4rem]">
                <img
                  src={CartIcon}
                  alt="Cart Icons"
                  className="text-white fill-white hidden sm:block"
                />
                <p className="sm:hidden">Tambah Keranjang</p>
              </Link>
