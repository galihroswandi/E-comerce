...
const getAllCheckout = (body) => {
    const SQLQuery = `SELECT * FROM checkout JOIN users ON checkout.id_user=users.id_user JOIN products ON checkout.id_product=products.id_product WHERE checkout.id_user='${body.id_user}'`;
